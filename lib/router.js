...
Router.route('/topic/:_id', {
  ...
  subscriptions: function() {
    return [Meteor.subscribe('topic', this.params._id), Meteor.subscribe('onlineUsers')]
  }
})
Router.route('/chat', {
  template: 'chat',
  ...
  data: function(){
    return {
        ...
        mainRoom : ChatRooms.findOne({})
      }
  },
  subscriptions: function() {
    var date = new Date();
    return [Meteor.subscribe('onlineUsers'), Meteor.subscribe('mainChatRoom', date)]
  }
})
